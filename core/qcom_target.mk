...
$(call project-set-path,qcom-display,hardware/qcom/display/sony)
$(call project-set-path,qcom-media,hardware/qcom/media/sony)
else
$(call project-set-path,qcom-display,hardware/qcom/display/$(QCOM_HARDWARE_VARIANT))
$(call project-set-path,qcom-media,hardware/qcom/media/$(QCOM_HARDWARE_VARIANT))
endif
